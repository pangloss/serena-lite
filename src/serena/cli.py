    ...
    def health_check(project: str) -> None:
        ...
        with FileLoggerContext(log_file, append=False, enabled=True):
            ...
            try:
                ...
                # Removed SearchForPatternTool test as tool was removed in serena-lite
                ...
                if len(find_refs_data) == 0:
                    log.warning("FindReferencingSymbolsTool found no matches - this might indicate an issue or the symbol has no references")
